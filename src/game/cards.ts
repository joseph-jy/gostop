...
export const CARDS: Card[] = [
  ...
  { id: 'january-hongdan', month: Month.January, type: CardType.Yeol,   imagePath: 'assets/cards/january-hongdan.png' },
  ...
  // February (2월)
  { id: 'february-hongdan', month: Month.February, type: CardType.Yeol,   imagePath: 'assets/cards/february-hongdan.png' },
  { id: 'february-bird', month: Month.February, type: CardType.Tti,   imagePath: 'assets/cards/february-bird.png' },
  ...
  { id: 'march-hongdan', month: Month.March, type: CardType.Yeol,   imagePath: 'assets/cards/march-hongdan.png' },
  ...
  // April (4월)
  { id: 'april-hongdan', month: Month.April, type: CardType.Yeol,   imagePath: 'assets/cards/april-hongdan.png' },
  { id: 'april-bird', month: Month.April, type: CardType.Tti,   imagePath: 'assets/cards/april-bird.png' },
  ...
  // May (5월)
  { id: 'may-hongdan', month: Month.May, type: CardType.Yeol,   imagePath: 'assets/cards/may-hongdan.png' },
  { id: 'may-bird', month: Month.May, type: CardType.Tti,   imagePath: 'assets/cards/may-bird.png' },
  ...
  // June (6월)
  { id: 'june-cheongdan', month: Month.June, type: CardType.Yeol,   imagePath: 'assets/cards/june-cheongdan.png' },
  { id: 'june-bird', month: Month.June, type: CardType.Tti,   imagePath: 'assets/cards/june-bird.png' },
  ...
  // July (7월)
  { id: 'july-chodan', month: Month.July, type: CardType.Yeol,   imagePath: 'assets/cards/july-chodan.png' },
  { id: 'july-bird', month: Month.July, type: CardType.Tti,   imagePath: 'assets/cards/july-bird.png' },
  ...
  { id: 'august-animal', month: Month.August, type: CardType.Tti,   imagePath: 'assets/cards/august-animal.png' },
  ...
  // September (9월)
  { id: 'september-chodan', month: Month.September, type: CardType.Yeol,   imagePath: 'assets/cards/september-chodan.png' },
  { id: 'september-animal', month: Month.September, type: CardType.Tti,   imagePath: 'assets/cards/september-animal.png' },
  ...
  // October (10월)
  { id: 'october-chodan', month: Month.October, type: CardType.Yeol,   imagePath: 'assets/cards/october-chodan.png' },
  { id: 'october-bird', month: Month.October, type: CardType.Tti,   imagePath: 'assets/cards/october-bird.png' },
  ...
  { id: 'november-pi-3', month: Month.November, type: CardType.Tti,   imagePath: 'assets/cards/november-pi-3.png' },

  // December (12월)
  { id: 'december-gwang', month: Month.December, type: CardType.Gwang,   imagePath: 'assets/cards/december-gwang.png' },
  { id: 'december-animal', month: Month.December, type: CardType.Tti,   imagePath: 'assets/cards/december-animal.png' },
