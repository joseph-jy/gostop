...
export const GODORI_IDS = ['february-bird', 'april-bird', 'august-animal'];

// 홍단: 1월, 2월, 3월의 띠
export const HONGDAN_IDS = ['january-hongdan', 'february-hongdan', 'march-hongdan'];

// 청단: 6월, 9월, 10월의 띠
export const CHEONGDAN_IDS = ['june-cheongdan', 'september-chodan', 'october-chodan'];

// 초단: 4월, 5월, 7월의 띠
export const CHODAN_IDS = ['april-hongdan', 'may-hongdan', 'july-chodan'];
